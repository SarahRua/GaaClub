...
namespace GAAClubFront
{
    ...
    public class Stats
    {
        ...
        {
            return "Mean Age: " + getMeanAge() + "\t\tMax Age: " + getMaxAge() + "\tMin Age: " + getMinAge()+"\n"+

            "Mean Run: " + getMeanDist() + "\tMax Run: " + getMaxDist() + "\tMin Run: " + getMinDist()+"\n"+
            "Mean Height: " + getMeanHeight() + "\tMax Height: " + getMaxHeight() + "\tMin Height: " + getMinHeight() + "\n" +
            "Mean Speed: " + getMeanSpeed() + "\tMax Speed: " + getMaxSpeed() + "\tMin Speed: " + getMinSpeed();
